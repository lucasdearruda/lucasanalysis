...
protons_pol->GetYaxis()->SetTitle("protons counts as a function of E_{NN} (MeV)");
protons_pol->SetTitle("");
...
leg_protons->AddEntry(protons_pol,"protons(Enn) from CH2", "l");
leg_protons->AddEntry(protons_carbon,"protons(Enn) from C", "l");
leg_protons->AddEntry(protons_spec,"resulting protons(Enn) (excluding C)", "l");
leg_protons->Draw();

protons_spec->SetLineWidth(2);
protons_pol->SetLineWidth(2);
protons_carbon->SetLineWidth(2);
//---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.
