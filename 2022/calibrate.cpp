...
// void plotPlots(int plot_nr = 1,int tel=1){
//     int i=tel-1;
//     if(plot_nr == 1){
//         si1si2[i]->Draw();
//     }else if(plot_nr == 2){
...
void plotRawDataG(int tel = 1){
    ...
    raw1 = new TH2D("raw1","raw1", Nbins,0*g2,30e3*g2,Nbins,0*g1,30e3*g1);
    raw2 = new TH2D("raw2","raw2", Nbins,0*g3,30e3*g3,Nbins,0*g2,30e3*g2);
