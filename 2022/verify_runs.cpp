//verify_runs.cpp, version 2025-08-18.1
// Script for veryfing the runs for 2022, so I can use in my calculations 
...
#include "/mnt/medley/LucasAnalysis/2022/src/loadcals.cc" //for loading calibrations:
...
void plotPIDall(TTree *Tree, int runN = 0, bool saveCanvas = true){
    loadCals("/mnt/medley/LucasAnalysis/2022/src/calibrations.dat");
...
void verify_runs(int runa = -1,int runb = -1, float sigma = 4, float threshold = 0.002, float guess = 400, float tofmin = 300, float tofmax = 500){
    ...
    string path_to_runs = "/mnt/medley/runswithMM_2022";
