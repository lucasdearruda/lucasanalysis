...
int main(int argc, char* argv[]) {
    ...
    const char * outputFileName  = Form("/home/e802/Analysis/LucasAnalysis/reducedData/altPID/%03ddeb.root",nrun);
    ...
    //some information to add
        ...
        TNamed *Processed_with = new TNamed("processed_with","processRun_debAltPID.cpp");
    ...
    timer.Print();
    cout<<"Compiled from processRun_debAltPID.cpp"<<endl;
    return 0;
