...
int main(int argc, char* argv[]) {
    ...
    const char * outputFileName  = Form("/media/dearruda/Elements/LucasAnalysis/2023/reduced/%03dv5.root",nrun);
    ...
    string cuts_path =   "/media/dearruda/Elements/LucasAnalysis/2023/PIDv5";
    ...
    //some information to add
        ...
        TNamed *processing_info= new TNamed("processed by processRun_v5d, version 5.29.10.24.0",cur_time);
    ...
    cout<<"Compiled from processRun_v5d.cpp, v5.2024.11.27.0"<<endl;
    return 0;
