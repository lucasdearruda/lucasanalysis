...
void C_px(Double_t Ea = 26.4, Double_t Eb = 27.4 ,Int_t runa = 35,Int_t runb = 39){
TStopwatch timer;
...
//#EN,ANG,E,DATA,ERR-S
txs->ReadFile("/mnt/medley/LucasAnalysis/exfor/exfor_files/n.xP_27.4-39.7-60.7_Subramanian.csv","EN/F:Ang/F:E/F:XS/F:XSerr/F");
//new TCanvas();
...
tl->AddEntry(graph,"Subramanian+(1983), 20deg","lpf");
tl->AddEntry(g40,"Subramanian+(1983), 40deg","lpf");
tl->AddEntry(g60,"Subramanian+(1983), 60deg","lpf");
tl->AddEntry(g80,"Subramanian+(1983), 80deg","lpf");
