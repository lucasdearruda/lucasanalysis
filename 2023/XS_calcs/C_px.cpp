...
void C_px(Double_t Ea = 26.0, Double_t Eb = 27.0 ,Int_t runa = 35,Int_t runb = 39){
TStopwatch timer;
...
{
    xsp->SetBinContent(i,1e3*Factor*hp->GetBinContent(i));//1e3 changes to mb
}
...
tl->AddEntry(xsp,"Slypen+(200)","lpf");
tl->AddEntry(graph,"Medley (2023)","lpf");
tl->Draw();
