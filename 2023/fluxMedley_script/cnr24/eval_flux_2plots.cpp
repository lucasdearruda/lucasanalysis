...
//#include "/home/e802/Analysis/LucasAnalysis/backups/useful.16.10.2024.h"
#include "/home/e802/Analysis/LucasAnalysis/useful.h"

//Wong's palette
// const Int_t nColors = 8;
...
// tof plots 
    ...
    TTofsCanvas->cd(2);
    tx->Draw("tofn_unc>>htofn_unc","PID==1 && cut_p_tof");
    tx_C->Draw("tofn_unc>>htofn_C_unc","PID==1 && cut_p_tof","same");
...
//---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.---ooOOOoo---.
    TH1D *hn = NeutronFromToF(htofEE,false);
    TH1D *hn_unc = NeutronFromToF(htofEE_unc,false);
