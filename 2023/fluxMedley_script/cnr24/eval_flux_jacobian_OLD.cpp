...
//run 370: 
    ...
    //integrateur double Q_CH2 = 239266 ;//µC
//run 388: 
    double Q_C = 292294 ;//µC
//integrateur    double Q_C =305744 ;//µC


int eval_flux_jacobian_OLD(){
 ...
 tx->SetAlias("myprotons", "PID==1");
 tx_C->SetAlias("myprotons", "PID==1");
 //selection of events
...
// tof plots 
    ...
    TTofsCanvas->cd(2);
    tx->Draw("tofn_unc>>htofn_unc","myprotons && cut_p_tof");
    tx_C->Draw("tofn_unc>>htofn_C_unc","myprotons && cut_p_tof","same");
