...
int main(int argc, char* argv[]) {
    ...
    //some information to add
        ...
        TNamed *processing_info= new TNamed("processed by processRun_v6d, version v6.2024.12.04.0",cur_time);
    ...
    cout<<"Compiled from processRun_v6d.cpp, v6.2024.12.04.0"<<endl;
    return 0;
