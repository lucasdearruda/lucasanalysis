//version 6.2024-12-06.0
// --> First condition for tritons: t_npt_1 AND csi < 0.5 MeV)
...
int main(int argc, char* argv[]) {
    ...
    auto result = GetRunData(infofile, nrun);

    if(result)cout<<". . . runData info properly obtained. "<<endl;
    else cout<<". . . runData info NOT properly obtained. "<<endl;
    ...
    const char * outputFileName  = Form("/media/dearruda/Elements/LucasAnalysis/2023/reducedv6/%03d.root",nrun);
    ...
    //some information to add
        ...
        TNamed *processing_info= new TNamed("processed by processRun_v6d:version6.2024-12-06.0",cur_time);
    ...
    cout<<"Compiled from processRun_v6d.cpp, version 6.2024-12-06.0"<<endl;
    return 0;
